 ...
 */
public class FsmFactoryImpl extends org.jdiameter.impl.fsm.FsmFactoryImpl implements IFsmFactory {
  ...
  public IStateMachine createInstanceFsm(IContext context, IConcurrentFactory concurrentFactory, Configuration config) throws InternalException {
    return new PeerFSMImpl(context, concurrentFactory, config, statisticFactory);
  }
}
