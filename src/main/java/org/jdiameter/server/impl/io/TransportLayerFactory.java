 ...
 */
public class TransportLayerFactory extends org.jdiameter.impl.transport.TransportLayerFactory implements ITransportLayerFactory {
  ...
  public TransportLayerFactory(Configuration conf, IConcurrentFactory concurrentFactory, IMessageParser parser, IMetaData metaData) throws TransportException {
    ...
    Configuration[] children = config.getChildren(org.jdiameter.impl.helpers.Parameters.Extensions.ordinal());
    // extract network guard class name.
    AppConfiguration internalExtensions = (AppConfiguration) children[org.jdiameter.impl.helpers.ExtensionPoint.Internal.id()];
