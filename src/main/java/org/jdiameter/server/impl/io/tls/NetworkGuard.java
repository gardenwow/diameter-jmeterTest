...
package org.jdiameter.server.impl.io.tls;
 ...
 import org.jdiameter.impl.transport.tls.TLSClientConnection;
 import org.jdiameter.impl.transport.tls.TLSUtils;
 import org.jdiameter.common.concurrent.DummyConcurrentFactory;
...
/**
 * TLS implementation of {@link INetworkGuard}.
 *
...
public class NetworkGuard implements INetworkGuard, Runnable {
  ...
  public NetworkGuard(InetAddress inetAddress, int port, IConcurrentFactory concurrentFactory, IMessageParser parser, IMetaData data) throws Exception {
    ...
    if (!conf.isAttributeExist(org.jdiameter.impl.helpers.Parameters.SecurityRef.ordinal())) {
      throw new IllegalArgumentException("No security_ref attribute present in local peer!");
    }

    String secRef = conf.getStringValue(org.jdiameter.impl.helpers.Parameters.SecurityRef.ordinal(), "");
