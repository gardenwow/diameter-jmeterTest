...
import org.jdiameter.impl.helpers.AppConfiguration;
import org.jdiameter.impl.helpers.Ordinal;
import org.w3c.dom.*;
...
import static org.jdiameter.impl.helpers.ExtensionPoint.*;
import static org.jdiameter.impl.helpers.Parameters.*;
...
public class XMLConfiguration extends EmptyConfiguration {
  ...
  protected void validate(Document document) throws Exception {
    ...
    Source schemaFile = new StreamSource(getClass().getResourceAsStream("C:\\Users\\sereg\\IdeaProjects\\diameter\\src\\main\\java\\config\\jdiameter-server.xsd"));
  ...
  protected void addThreadPool(Node item) {
    AppConfiguration threadPoolConfiguration = org.jdiameter.impl.helpers.EmptyConfiguration.getInstance();
  ...
  protected void addConcurrent(org.jdiameter.impl.helpers.Parameters name, Node node) {
    NodeList c = node.getChildNodes();
  ...
  protected void addStatisticLogger(org.jdiameter.impl.helpers.Parameters name, Node node) {
  ...
  protected void addDictionary(org.jdiameter.impl.helpers.Parameters name, Node node) {
  ...
  protected void addRequestTable(org.jdiameter.impl.helpers.Parameters name, Node node) {
  ...
  protected void addExtensions(Node node) {
    ...
    for (int i = 0; i < c.getLength(); i++) {
      ...
      if (nodeName.equals("MetaData")) {
        ...
        add(org.jdiameter.impl.helpers.ExtensionPoint.InternalAgentConfiguration, getValue(c.item(i)));
      }
  ...
  protected void addInternalExtension(Ordinal ep, String value) {
    Configuration[] extensionConfs = this.getChildren(org.jdiameter.impl.helpers.Parameters.Extensions.ordinal());
    AppConfiguration internalExtensions = (AppConfiguration) extensionConfs[org.jdiameter.impl.helpers.ExtensionPoint.Internal.id()];
