 ...
 */
public class ExtensionPoint extends org.jdiameter.impl.helpers.ExtensionPoint {
  ...
  protected ExtensionPoint(String name, org.jdiameter.impl.helpers.ExtensionPoint... parameters) {
    super(name, parameters);
  }

  protected ExtensionPoint(String name, int id, org.jdiameter.impl.helpers.ExtensionPoint... parameters) {
