 ...
 */
public class Parameters extends org.jdiameter.impl.helpers.Parameters {
  ...
  public static final Parameters RequestTableSize = new Parameters("RequestTableSize", Integer.class, 10240);

  public static final Parameters RequestTableClearSize = new Parameters("RequestTableClearSize", Integer.class, 2048);
