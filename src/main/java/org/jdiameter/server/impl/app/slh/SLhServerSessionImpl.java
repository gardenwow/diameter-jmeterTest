...
import org.jdiameter.common.concurrent.app.slh.ISLhMessageFactory;
import org.jdiameter.common.concurrent.app.slh.SLhSessionState;
import org.jdiameter.api.AppAnswerEventImpl;
import org.jdiameter.api.AppRequestEventImpl;
import org.jdiameter.api.slh.SLhSession;
      ...
      try {
        switch (request.getCommandCode()) {
          case LCSRoutingInfoRequest.code:
            handleEvent(
                new Event(Type.RECEIVE_RIR, messageFactory.createLCSRoutingInfoRequest(request), null));
            break;
