...
import org.jdiameter.common.concurrent.app.s13.IS13MessageFactory;
import org.jdiameter.common.concurrent.app.s13.S13SessionState;
import org.jdiameter.api.AppAnswerEventImpl;
import org.jdiameter.api.AppRequestEventImpl;
import org.jdiameter.api.s13.S13Session;
      ...
      try {
        switch (request.getCommandCode()) {
          case JMEIdentityCheckRequest.code:
            handleEvent(new Event(Type.RECEIVE_ECR, messageFactory.createMEIdentityCheckRequest(request), null));
            break;
