package org.jdiameter.validation;
...
public class DictionaryImpl implements Dictionary {
  ...
  public static Dictionary INSTANCE = getInstance("C:\\Users\\sereg\\IdeaProjects\\diameter\\src\\main\\java\\config\\dictionary1.xml");
  ...
  public static Dictionary getInstance(InputStream is) {
    if (is == null) {
      ...
      String confFile = INSTANCE.toString();
  ...
  public static Dictionary getInstance(String confFile) {
    if (confFile == null) {
      ...
      confFile = "C:\\Users\\sereg\\IdeaProjects\\diameter\\src\\main\\java\\config\\config-client.xml";
    }
  ...
  private static InputStream getInputStream(String confFile) {
    ...
    try {
      is = DictionarySingleton.class.getClassLoader().getResourceAsStream(confFile);
      if (is == null) {
      ...
      if (is == null) {
        ...
        if (fDict.exists()) {
          ...
          fDict = new File("config/dictionary.xml" + confFile);
          if (fDict.exists()) {
            is = new FileInputStream(fDict);
          }
        }
